...
public enum OSCAPressReleaseError: Swift.Error, CustomStringConvertible {
...
}// end public enum OSCAPressReleaseError

extension OSCAPressReleaseError: Equatable{
  public static func == (lhs: OSCAPressReleaseError, rhs: OSCAPressReleaseError) -> Bool {
    switch (lhs, rhs) {
...
}// end extension public enum OSCAPressReleaseError
